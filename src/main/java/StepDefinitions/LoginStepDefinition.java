 ...
 * 
 * 
 * @Given("^user is already in Login page$") public void
 * user_already_on_login_page() throws InterruptedException {
 * 
 * System.setProperty("webdriver.chrome.driver",
 * "D:\\Downloads\\chromedriver_win32\\chromedriver.exe"); ChromeOptions opt=new
 * ChromeOptions(); opt.addArguments("--disable-notifications"); driver = new
 * ChromeDriver(opt); driver.get("https://ui.cogmento.com/");
 * 
 * }
 * 
 * @When("^user title of login page is makemytrip$") public void
 * user_title_of_login_page_is_makemytrip() {
 * 
 ...
 * }
 * 
 * @Then("^user is on Homepage$") public void user_is_on_Homepage() {
 * 
 * System.out.println("The user is on home page"); driver.quit();
 * 
 * } }
 */